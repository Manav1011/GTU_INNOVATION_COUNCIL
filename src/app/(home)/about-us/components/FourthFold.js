...
async function FourthFold() {
  return (
    <section
      className="h-screen w-screen bg-white bg-opacity-50"
      id="about-us-fourthfold"
      style={{ backgroundAttachment: "fixed" }}
    >
    <div className="" id="about-us-fourthfold-content">
      <div
        className="bottomUPTitle  xs:text-5xl xs:pt-52 font-thin sm:text-5xl lg:text-7xl  text-5xl sm:pt-28 lg:pt-32 pt-52 sm:px-10 text-center"
