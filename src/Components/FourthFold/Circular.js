...
function Circular({ content, id }) {
  return (
    <div className="z-20 relative sm:m-2 m-3 text-blue-600 circulars" style={{ fontFamily: "JustAnotherHand" }}>
      <span className="absolute -z-10  w-full h-full inset-1  rounded-xl"></span>
      <div
        className="p-2 sm:p-7 purple_border  rounded-xl z-20 font-ligh">
        <div className="pt-2 pb-4 last:mb-0 border-black border-solid">
          <div className="flex sm:items-center justify-between font-sm text-justify flex-col sm:flex-row items-start">
            <span className="sm:mr-10 text-lg font-light sm:text-3xl">
              {content}
            </span>
            <a
              href="#"
              className="sm:hidden sm:w-auto w-full mt-5 sm:mt-0 border p-2 text-center rounded-md border-black flex justify-center items-center"
            >
