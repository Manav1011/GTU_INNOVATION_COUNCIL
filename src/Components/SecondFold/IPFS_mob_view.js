async function IPFS_mob_view({hidden}){
  ...
  <img src="/images/secondfold/IPR.webp" alt="Your Image" className="px-3"/>
  ...
  <div class="group absolute inset-0 h-full flex flex-col items-center rounded-lg justify-center bg-black bg-opacity-60 opacity-0 hover:opacity-100 transition-opacity duration-300 gap-y-2 hover:h-full hover:duration-1000">
    <p className="text-white text-left font-bold text-xl group-hover:animate-fade-in-up">About IPFS</p>
    <p class="text-white text-center group-hover:animate-fade-in-up">The Intellectual Property Facilitation Centre (IPFC) at ni-msme since August 2009 offers consultancy to MSMEs on trademarks, copyrights, patents, and geographical indications, with incentives for national and international patents provided by the Government of India.</p>
  </div>
</div> */}
