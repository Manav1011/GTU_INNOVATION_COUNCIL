async function Idealab_mob_view({hidden}){
  ...
  <img src="/images/secondfold/IDEALAB.webp" width={899} height={268} alt="Your Image" class="w-full h-full object-cover rounded-lg shadow dark:shadow-black/20 rtl:divide-x-reverse"/>
