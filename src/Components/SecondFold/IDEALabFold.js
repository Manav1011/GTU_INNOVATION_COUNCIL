                    ...
                    <div className="mb-12 w-full shrink-0 grow-0 basis-auto lg:mb-0 lg:w-5/12">
                      <div className="flex lg:py-10 lg:justify-end">
                        <img
                          ...
                          className="z-[10] w-2/5 sm:w-full rounded-lg p-10 shadow dark:shadow-black/20 lg:ml-[50px]"
                          alt="image"
                        />
                      </div>
                    </div>
