...
function NavToggler() {
  ...
  const toggleSidebar = async () => {
    ...
    let NavigationSidebar = document.getElementById("NavigatiionSidebarMobile");    
  ...
  const toggleSidebarDesktop = async () => {
    // document.body.classList.toggle('sm:overflow-hidden')
    // document.getElementById('gtu-logo').classList.toggle('sm:hidden')
    // document.getElementById('gic-logo').classList.toggle('sm:hidden')
    let NavigationSidebar = document.getElementById("NavigationSidebar");    
        NavigationSidebar.classList.toggle("hidden");    
    document.getElementById("NavTogglerOpenDesktop").classList.toggle('hidden')
    document.getElementById("NavTogglerClosedDesktop").classList.toggle('hidden')
    // setSidebarOn(!SidebarOn);
  };
  // useEffect(() => {
  ...
  return (
    ...
    <div className="cursor-pointer hidden lg:flex" onClick={toggleSidebarDesktop}>      
    <div className="hidden" id="NavTogglerOpenDesktop">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width={52}
          height={52}
        ...
        <div className="" id="NavTogglerClosedDesktop">
        <svg
          viewBox="0 0 30 40"
          xmlns="http://www.w3.org/2000/svg"
          aria-hidden="true"
