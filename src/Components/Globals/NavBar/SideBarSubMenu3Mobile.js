...
function SideBarSubMenu3Mobile({ title }) {
  ...
  return (
    <section
      className="z-20 w-full top-0 fixed h-[100dvh] overflow-y-scroll overflow-x-hidden sm:hidden sm:w-1/4 bg-zinc-300 flex flex-col gap-10 justify-start sm:justify-center items-start sm:pt-14 pt-28"
