...
async function SixthFold() {
  return (
    ...
    //         <h2 className="text-3xl sm:text-7xl font-extrabold tracking-tight text-slate-700 ">
    //             STARTUP STATISTICS
    //         </h2>
    //         <p className="text-lg leading-8 sm:text-3xl text-slate-700">
    ...
    //           </dd>
    //         </div>
    //         <div className="flex flex-col bg-black sm:bg-slate-200 bg-opacity-90 p-8"  style={{gridColumn:'1 / -1'}}>
